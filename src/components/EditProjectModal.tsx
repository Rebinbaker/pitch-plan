...
export function EditProjectModal({ isOpen, onClose, project, onUpdateProject, teams = [] }: EditProjectModalProps) {
  console.log('EditProjectModal rendered:', { isOpen, project: project?.name, teamsCount: teams.length });
  ...
  const onSubmit = async (data: EditProjectFormValues) => {
    ...
    try {
      ...
      toast({
        title: 'Fel vid uppdatering av projekt',
        description: 'Det uppstod ett fel vid uppdateringen av projektet. Försök igen.',
        variant: 'destructive',
      });
    } finally {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isSubmitting}>
                {isSubmitting ? 'Uppdaterar...' : 'Uppdatera projekt'}
              </Button>
            </DialogFooter>
          </form>
        </Form>
