  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-lg h-[95vh] flex flex-col p-0">
          ...
          <Tabs defaultValue="overview" className="flex-1 flex flex-col min-h-0">
            ...
            <TabsContent value="checklist" className="flex-1 overflow-y-auto px-6 pb-6 mt-4">
              <ProjectChecklist 
            ...
            <TabsContent value="workphases" className="flex-1 overflow-y-auto px-6 pb-6 mt-4">
              <WorkPhasesSection 
                project={project}
                onUpdateProject={onUpdate}
                teams={teams}
